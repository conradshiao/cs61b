...
public class RationalTest {
    ...
    @Test public void equalrat1() {
        Rational r = frac(5, 7);
        Rational x = frac(20, 28);
        boolean z = equalrat(x, r);
        assertTrue("should be equal", z);
    }

    @Test public void equalrat2() {
        Rational r = frac(10, 14);
        Rational x = frac(10, 16);
        boolean z = equalrat(x, r);
        assertFalse("should be unequal", z);
    }
}
